...
from error_handling import Incorrect_Input_error
...
class userInput:
    ...
    def __repr__(self):
        return 'userInput({},{},{},{},{})'.format(self.game, self.num_sides, [("Team(" + str(i) + ")") for i in range(len(self.teams))],self.num_trials, self.display_board_positions)
    ...
    def get_teams(self):
        ...
        teams = [{str("team_" + str(i)): {"team_name": None,"color": None,"skill": None,"strategy": None}   } for i in range(self.num_sides)]
        ...
        for i in range(self.num_sides):
            ...
            while not done:
                ...
                try:
                    ...
                    team_board_name = input("Choose a name for this team [e.g. 'blue_team' or 'green_team']: ")
            ...
            while not done:
                try:
                    skill_level = int(input("Please enter team's skill_level [1 = Novice, 10 = expert]: "))
            ...
            while not done:
                try:
                    strategy = int(input("Please enter team's strategy [0 = 'cooperative', 1 = 'competitive']: ").lower())
                    choices = [0, 1]
    ...
    def get_num_trials(self):
        ...
        while not done:
            try:
                ...
                trials = int(input("How many trials would you like to run? [1 - 1,000,000] "))
    ...
    def get_display_status(self):
        ...
        while not done:
            try:
                display_results = str(input("Do you want to see the board positions in realtime? [ 'Yes' or 'No' ]")).lower()
                choices = ["yes", "no"]
